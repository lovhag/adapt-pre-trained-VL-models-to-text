...
MODEL_NAME="clipbert-no-visual-features-finetuned-wikipedia"
...
python -m GLUE.src.benchmark_model_GLUE \
	...
	--model-weights-path "adaptations/data/runs/finetune/clip-bert-wikipedia/best_global_step120/mp_rank_00_model_states.pt" \
