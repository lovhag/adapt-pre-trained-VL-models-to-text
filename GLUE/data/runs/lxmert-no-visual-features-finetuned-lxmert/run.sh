...
MODEL_NAME="lxmert-no-visual-features-finetuned-lxmert"
...
python -m GLUE.src.benchmark_model_GLUE \
	...
	--model-weights-path "adaptations/data/runs/finetune/lxmert-lxmert/best_global_step400/mp_rank_00_model_states.pt" \
