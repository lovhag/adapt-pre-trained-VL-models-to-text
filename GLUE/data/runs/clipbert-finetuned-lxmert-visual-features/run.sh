...
MODEL_NAME="clipbert-finetuned-lxmert-visual-features"
...
python -m GLUE.src.benchmark_model_GLUE \
	...
	--visual-features-path "adaptations/data/runs/finetune-visual-features/clip-bert-lxmert/best_global_step_features4520.pt" \
