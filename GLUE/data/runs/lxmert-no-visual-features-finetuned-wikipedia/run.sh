...
MODEL_NAME="lxmert-no-visual-features-finetuned-wikipedia"
...
python -m GLUE.src.benchmark_model_GLUE \
	...
	--model-weights-path "adaptations/data/runs/finetune/lxmert-wikipedia/best_global_step1200/mp_rank_00_model_states.pt" \
