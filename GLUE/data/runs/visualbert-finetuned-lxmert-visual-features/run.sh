...
MODEL_NAME="visualbert-finetuned-lxmert-visual-features"
...
python -m GLUE.src.benchmark_model_GLUE \
	...
	--visual-features-path "adaptations/data/runs/finetune-visual-features/visualbert-lxmert/best_global_step_features5920.pt" \
