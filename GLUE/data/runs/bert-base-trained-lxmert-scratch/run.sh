...
MODEL_NAME="bert-base-uncased-trained-lxmert-scratch"
...
python -m GLUE.src.benchmark_model_GLUE \
	...
	--model-weights-path "models/data/model-weights/bert-lxmert-trained-scratch/mp_rank_00_model_states.pt" \
