...
MODEL_NAME="clipbert-no-visual-features-finetuned-lxmert"
...
python -m GLUE.src.benchmark_model_GLUE \
	...
	--model-weights-path "adaptations/data/runs/finetune/clip-bert-lxmert/best_global_step320/mp_rank_00_model_states.pt" \
