...
MODEL_NAME="lxmert-finetuned-wikipedia-visual-features"
...
python -m GLUE.src.benchmark_model_GLUE \
	...
	--visual-features-path "adaptations/data/runs/finetune-visual-features/lxmert-wikipedia/best_global_step_features72320.pt" \
	--visual-boxes-path "adaptations/data/runs/finetune-visual-features/lxmert-wikipedia/best_global_step_boxes72320.pt" \
