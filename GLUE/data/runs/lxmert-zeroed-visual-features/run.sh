...
MODEL_NAME="lxmert-zeroed-visual-features"
...
python -m GLUE.src.benchmark_model_GLUE \
	...
	--visual-features-path "adaptations/data/zeroed-visual-features/frcnn_features.pt" \
	--visual-boxes-path "adaptations/data/zeroed-visual-features/frcnn_boxes.pt" \
