...
MODEL_NAME="lxmert-zero-image-visual-features"
...
python -m GLUE.src.benchmark_model_GLUE \
	...
	--visual-features-path "adaptations/data/zero-image-visual-features/frcnn_features.pt" \
	--visual-boxes-path "adaptations/data/zero-image-visual-features/frcnn_boxes.pt" \
