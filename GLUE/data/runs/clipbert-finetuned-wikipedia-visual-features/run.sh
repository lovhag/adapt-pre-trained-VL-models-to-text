...
MODEL_NAME="clipbert-finetuned-wikipedia-visual-features"
...
python -m GLUE.src.benchmark_model_GLUE \
	...
	--visual-features-path "adaptations/data/runs/finetune-visual-features/clip-bert-wikipedia/best_global_step_features75600.pt" \
