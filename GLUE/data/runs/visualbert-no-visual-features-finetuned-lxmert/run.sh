...
MODEL_NAME="visualbert-no-visual-features-finetuned-lxmert"
...
python -m GLUE.src.benchmark_model_GLUE \
	...
	--model-weights-path "adaptations/data/runs/finetune/visualbert-lxmert/best_global_step600/mp_rank_00_model_states.pt" \
